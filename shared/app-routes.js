(function () {
  const ROUTES = {
    ...
    cashier: {
      ...
      splitPayments: "cashier/pos.html#split-payments",
      paymentHistory: "cashier/pos.html#payment-history",
      salesHistory: "cashier/pos.html#sales-history",
  ...
  const ROLE_NAVIGATION = {
    ...
    cashier: [
      ...
      { label: "Split Payments", route: ROUTES.cashier.splitPayments },
      { label: "Payments", route: ROUTES.cashier.paymentHistory },
      { label: "Sales History", route: ROUTES.cashier.salesHistory },
